...
class Pool {
	...
	resume() {
		...
		if (!maps.restarting.has(this) && maps.drain.has(this)) {
			maps.drain.get(this)
				.then(function() {
					maps.drain.delete(self);
					maps.restarting.delete(self);
				});
		}
	}
